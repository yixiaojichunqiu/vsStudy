...
function createTrackClip(animator, easing, oneTrackDone, keyframes, propName, forceAnimate) {
  ...
  var useSpline = easing === 'spline'; //frame 传入两个位置时为2
  ...
  var trackMaxTime; // Sort keyframe as ascending 按time排序
  ...
  for (var i = 0; i < trackLen; i++) {
    ...
    var value = keyframes[i].value; // Check if value is equal, deep check if value is array 比较这一次和上一次value
